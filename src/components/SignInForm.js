    ...
    return (
      <div>
        ...
        >
          ...
          <button className="border-2 border-opacity-10 border-richBlack flex space-x-2 rounded bg-semiWhite text-richBlack py-2 px-4 w-full justify-center font-semibold">
            <svg
